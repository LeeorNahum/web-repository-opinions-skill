...
The database references object keys, and object storage never becomes a second app database. The app reads subscription truth from the billing provider rather than mirroring it as the authority.
